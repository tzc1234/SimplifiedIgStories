...
class StoryViewModelTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        sut = StoryViewModel(storyId: firstHasPortionStory!.id, storiesViewModel: storiesViewModel)
...
extension StoryViewModelTests {
    ...
    private func make2ndStorySUT() -> StoryViewModel {
        ...
        return StoryViewModel(storyId: secondStory.id, storiesViewModel: storiesViewModel)
    }
}
