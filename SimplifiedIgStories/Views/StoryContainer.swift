    ...
    var body: some View {
        HStack(alignment: .top, spacing: 0) {
            ...
            ForEach(modelData.stories.indices) { index in
                ...
                .ignoresSafeArea()
                .opacity(index != storyGlobal.currentStoryIndex && !storyGlobal.shouldAnimateCubicRotation ? 0.0 : 1.0)
        ...
        .gesture(
            DragGesture()
                .updating($translation) { value, state, transaction in
                    ...
                    storyGlobal.storyIndexBeforeDragged = storyGlobal.currentStoryIndex
                ...
                .onEnded { value in
                    ...
                    if (storyGlobal.currentStoryIndex == 0 && offset > 0.2) ||
                        (storyGlobal.currentStoryIndex == storyCount - 1 && offset < -0.2) {
