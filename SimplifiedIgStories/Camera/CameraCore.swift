...
enum CameraCoreStatus: Equatable {
    case sessionStarted
    case sessionStopped
...
final class AVCameraCore: NSObject, CameraCore, CaptureDevice, AuxiliarySupportedCamera {
    private let statusPublisher = PassthroughSubject<CameraCoreStatus, Never>()
...
extension AVCameraCore {
    ...
    private func configureSession(action: (AVCameraCore) throws -> Void) {
